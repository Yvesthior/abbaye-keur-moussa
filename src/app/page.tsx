...
import { ArrowRight, Music, Heart, ShoppingBag, BookOpen, Clock, MapPin } from "lucide-react";
      ...
      <section className="relative h-[75vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl">
          ...
          <p className="text-lg md:text-xl font-body mb-10 opacity-90 leading-relaxed max-w-2xl mx-auto">
            Bienvenue au cœur de la spiritualité bénédictine au Sénégal. Un havre de prière, de travail et de silence à 50km de Dakar.
          </p>
      ...
      <section className="bg-primary text-primary-foreground py-12">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
          <div className="space-y-3">
            <Clock className="mx-auto text-secondary h-10 w-10" />
            <h3 className="font-headline text-2xl font-bold">Messe Quotidienne</h3>
            <p className="text-base opacity-90">
              Lundi – Samedi : <span className="font-bold">08:00</span><br />
              Dimanche : <span className="font-bold">10:00</span> (Messe chantée)
            </p>
          </div>
          <div className="space-y-3">
            <Music className="mx-auto text-secondary h-10 w-10" />
            <h3 className="font-headline text-2xl font-bold">Vêpres à la Kora</h3>
            <p className="text-base opacity-90">
              Tous les soirs à <span className="font-bold">18:30</span><br />
              Liturgie chantée accompagnée à la Kora.
            </p>
          </div>
          <div className="space-y-3">
            <MapPin className="mx-auto text-secondary h-10 w-10" />
            <h3 className="font-headline text-2xl font-bold">Nous Trouver</h3>
            <p className="text-base opacity-90">
              Sébikotane, Sénégal<br />
              Ouvert aux visiteurs de 08:00 à 18:00.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <FeatureCard
              title="La Boutique"
              description="Découvrez nos produits monastiques : miel, huiles, encens et artisanat d'art faits main."
              icon={<ShoppingBag className="w-6 h-6" />}
              href="/shop"
            />
            <FeatureCard
              title="Méditation IA"
              description="Recevez une réflexion spirituelle quotidienne inspirée de la règle de Saint Benoît."
              icon={<BookOpen className="w-6 h-6" />}
              href="/reflection"
            />
            <FeatureCard
              title="Faire un Don"
              description="Soutenez l'entretien du sanctuaire et les œuvres sociales de la communauté."
